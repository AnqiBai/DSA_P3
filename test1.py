...
roads = [[7, 6, 5],
         ...
         [9],
         [8]]
map_10 = MyMap(intersections, roads)
print(shortest_path(map_10, 7, 4))
print(shortest_path(map_10, 4, 4))
print(shortest_path(map_10, 4, 0))
'''

intersections_40 = {0: [0.7801603911549438, 0.49474860768712914],
...
roads_40 = [[36, 34, 31, 28, 17],
            ...
            [23, 29, 32],
            [2, 4, 7, 22, 28, 36]]
map_40 = MyMap(intersections_40, roads_40)
